...
<body>
    <header>
        <div><img id="jellyfish_logo" src="img/jellyfish_logo.png" alt="logo" width=50px></div> <div class="paradise"> Jellyfish Paradise </div>
           ...
           <br>
              <h1 class="text-center" style="color: #06C3D0;">CADASTRO DE PRODUTO</h1>
            <br>
     <div class="campos_respostas">
    <form action="#" method="POST">
        
          
              <label class="form-label"><h3>Nome do Produto</h3>
            ...
            <br>
            <label class="form-label"><h3>Empresa Fornecedora</h3>
                <input type="text"  name="nomef" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
              <br>
              <label class="form-label"><h3>CNPJ da Fornecedora</h3>             
            ...
            <br>
              ...
              <br>
              <label class="form-label"><h3>Lote</h3> <input type="number" name="lote"style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
              
              <br>
              <label class="form-label"><h3>Data de Validade</h3> <input type="date"  name="dt" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
...
if(!empty($_POST))
{
  $cliente = array($_POST['nome'], $_POST['cnpj'], $_POST['nomef'], $_POST['cep'], $_POST['rua'], $_POST['num'], $_POST['bairro'], $_POST['cidade'], $_POST['estado'], $_POST['lote'], $_POST['dt'] );
...
";
  ...
  $caminho = "cadastros/produto.txt"; //caminho onde sera criado o arquivo
