...
<body>
    ...
    <h1 class="text-center" style="color: #06C3D0;">CADASTRO DE USUÁRIO</h1>
    <br>
    <div class="campos_respostas">
      <form action="#" method="POST">
        
          
              <label class="form-label"><h3>Nome de Usuário</h3>
                ...
                <br>
              <label class="form-label"><h3>Data de Nascimento</h3> <input type="date"  name="dt" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
              <br>
              <label class="form-label"><h3>Departamento</h3><input type="text" name="depto" id="depto" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
              <br>
              ...
              <br>
              <label class="form-label"><h3>Cargo</h3> <input type="text"  name="car" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
...
if(!empty($_POST))
{
  $cliente = array($_POST['nome'],$_POST['dt'],$_POST['depto'],  $_POST['cpf'], $_POST['car'], $_POST['cep'], $_POST['rua'], $_POST['num'], $_POST['bairro'], $_POST['cidade'], $_POST['estado'], $_POST['celular'], $_POST['email'] );
...
";
  ...
  $caminho = "cadastros/usuario.txt"; //caminho onde sera criado o arquivo
