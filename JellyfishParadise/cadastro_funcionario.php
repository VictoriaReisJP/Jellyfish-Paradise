...
<body>
    <header>
      <div><img id="jellyfish_logo" src="img/jellyfish_logo.png" alt="logo" width=50px></div> <div class="paradise"> Jellyfish Paradise </div>
           ...
           <br>
              <h1 class="text-center" style="color: #06C3D0;">CADASTRO DE FUNCIONÁRIO</h1>
            <br>
    ...
    <form action="#" method="POST">
            ...
            <br>
              ...
              <br>
              <br>
              <label class="form-label"><h3>Departamento</h3> <input type="depto"  name="depto" style="border-radius: 30px;border: 3px solid #CB9FBB;  width: 400px;height: 40px; color: #06C3D0;" required></label>
              <br>
...
if(!empty($_POST))
{
  $cliente = array($_POST['nome'], $_POST['cpf'], $_POST['rg'], $_POST['cep'], $_POST['rua'], $_POST['num'], $_POST['bairro'], $_POST['cidade'], $_POST['estado'], $_POST['celular'], $_POST['email'], $_POST['depto'] );
...
";
  ...
  $caminho = "cadastros/funcionario.txt"; //caminho onde sera criado o arquivo
